...
# read in data
data_1 <- here::here("inst/tutorials/mystery/data","gun.csv") %>% readr::read_csv(file = .)

data_2 <- here::here("inst/tutorials/mystery/data","sword.csv") %>% readr::read_csv(file = .)

data_3 <- here::here("inst/tutorials/mystery/data","bottle.csv") %>% readr::read_csv(file = .)

sus_data <- here::here("inst/tutorials/mystery/data","sus_data.csv") %>% readr::read_csv(file = .)

print_1 <- here::here("inst/tutorials/mystery/data","print_1.csv") %>% readr::read_csv(file = .)

print_2 <- here::here("inst/tutorials/mystery/data","print_2.csv") %>% readr::read_csv(file = .)
