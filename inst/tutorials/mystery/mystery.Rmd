...
# read in data
data_1 <- here::here("www/gun.csv") %>% readr::read_csv(file = .)

data_2 <- here::here("www/sword.csv") %>% readr::read_csv(file = .)

data_3 <- here::here("www/bottle.csv") %>% readr::read_csv(file = .)

sus_data <- here::here("www/sus_data.csv") %>% readr::read_csv(file = .)

print_1 <- here::here("www/print_1.csv") %>% readr::read_csv(file = .)

print_2 <- here::here("www/print_2.csv") %>% readr::read_csv(file = .)
